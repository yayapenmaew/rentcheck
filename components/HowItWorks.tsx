const steps = [
  {
    num: "01",
    title: "ค้นหาตามโอกาส",
    body: "กรองตามงานที่จะไป ไซส์ และทำเล — เห็นทุกร้านที่ตรงกับความต้องการของคุณ",
  },
  {
    num: "02",
    title: "เปรียบเทียบร้านแบบเคียงกัน",
    body: "ไม่ต้องเปิดแท็บสิบแท็บจาก Instagram อีกต่อไป",
  },
  {
    num: "03",
    title: "ทักร้านโดยตรง",
      ...
      <div className="max-w-[1180px] mx-auto px-4 sm:px-8">
        <div className="max-w-[560px] mb-10 sm:mb-12">
          ...
          <p className="text-ink-soft text-[1.02rem]">
            RentCheck ไม่ได้จัดการการจอง — แค่พาคุณไปถึงร้านที่ใช่ได้เร็วขึ้น แล้วก็หายไป
          </p>
        </div>
